...
const marisela = new Person("Marisela Espinoza", true);

//print attributes
console.log(marisela.name)
console.log(marisela.softwareEngineer)

//calling the methods (invoke)
marisela.walk();
marisela.eat("chicken")
marisela.laugh = function (){
    console.log("This is so funny!")
}
marisela.laugh()
marisela.addArtist("Coldplay")


//view an attribute
console.log(marisela.artists)
